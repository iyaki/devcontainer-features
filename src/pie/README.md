...
Installs PIE — the official PHP extension installer (replaces PECL) — from the [php/pie](https://github.com/php/pie) GitHub Releases as a self-contained static binary.
